...
describe "OnlineOrder" do
  describe "#initialize" do
    it "Is a kind of Order" do
      ...
      online_order = OnlineOrder.new(1337, 3)
      online_order.must_be_kind_of Grocery::Order
    end

    it "Can access Customer object" do
      online_order = OnlineOrder.new(1337, 3, :paid)
  ...
  describe "#total" do
    it "Adds a shipping fee" do
      ...
      online_order = OnlineOrder.new(1337, 3, :pending, {"banana" => 1.0, "apple" => 1.25, "whole milk" => 3.59})
