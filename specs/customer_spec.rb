...
describe "Customer" do
  ...
  describe "Customer.find" do
    it "Can find the first customer from the CSV" do
      ...
      first.email.must_equal "leonard.rogahn@hagenes.org"
    end

    it "Can find the last customer from the CSV" do
      last = Grocery::Customer.find(35)
      last.id.must_equal 35
      last.email.must_equal "rogers_koelpin@oconnell.org"
    end

    it "Raises an error for a customer that doesn't exist" do
      proc {Grocery::Customer.find(50) }.must_raise ArgumentError
